...
export function LoginForm({ submit }: { submit: (credentials: Credentials) => void }) {
  ...
  return (
    ...
    >
      <Form.Description title="" text="Please enter your iCloud credentials. A session will be established after a successful login. Your password will not be stored." />
